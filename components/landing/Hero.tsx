      ...
      <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8">
        <div className="space-y-5 max-w-4xl mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            Tackle hands-on projects designed to sharpen your skills, from
            beginner to advanced. Explore challenges covering hooks, state
          ...
          <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
            ...
            <a
              href="#"
              className="block py-2 px-4 text-white hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg"
            >
              Join the community
            </a>
          </div>
